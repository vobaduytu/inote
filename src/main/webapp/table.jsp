                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="card-title">
                                        <h3 class="text-center title-2">Ghi chú mới</h3>
                                    </div>
                                    <hr>
                                    <form action="" method="post" novalidate="novalidate">
                                        <div class="form-group">
                                            <label for="cc-payment" class="control-label mb-1">Tiêu Đề</label>
                                            <input id="cc-payment" name="title" type="text" class="form-control"
                                                   aria-required="true" aria-invalid="false">
                                        </div>
                                        <div class="form-group has-success">
                                            <label for="cc-name" class="control-label mb-1">Nội Dung</label>
                                            <input id="cc-name" name="content" type="text"
                                        ...
                                        <%--                                        <div class="form-group">--%>
                                        <%--                                            <label for="cc-number" class="control-label mb-1">Thể Loại</label>--%>
                                        ...
                                        <div>
                                            <div class="col-md-3 mb-3">
                                                <select name="list" class="custom-select" id="validationDefault04"
                                                        required>
