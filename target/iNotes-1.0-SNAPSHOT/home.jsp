        ...
        <nav class="navbar-mobile">
            <div class="container-fluid">
                <ul class="navbar-mobile__list list-unstyled">
                    ...
                    <li>
                        <a href="table.html">
                            <i class="fas fa-table"></i>Cho Trường học</a>
                    </li>
                    <li>
                        <a href="form.html">
                            <i class="far fa-check-square"></i>Cho cuộc sống</a>
                    </li>
                    <li>
                        <a href="calendar.html">
                            <i class="fas fa-calendar-alt"></i>Nhật kí</a>
                    </li>
                    <li>
                        <a href="map.html">
                            <i class="fas fa-map-marker-alt"></i>Nhắc Nhở</a>
                    </li>
                </ul>
            </div>
        </nav>
