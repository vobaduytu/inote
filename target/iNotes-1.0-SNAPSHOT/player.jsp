        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12 col-md-12">
                    <h3 class="title-5 m-b-35">Đăng Kí Tài Khoản Mới</h3>
                </div>
                <div class="row ml-3 mb-3">
                    <a href="nome" type="button" class="btn btn-primary">Exit</a>
                </div>
            </div>
            <div class="row">
                        ...
                        <div class="card-body card-block">
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" name="fullname" id="title" placeholder="fullname"
                                           required value="${Login.fullname}" class="form-control">
                                </div>
                            </div>
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="password" name="password" id="password" placeholder="password"
                                           required value="${Login.password}" class="form-control">
                                </div>
                            </div>
